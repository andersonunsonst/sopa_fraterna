                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="/colaborador/{{ $colaborador->id }}">
                            ...
                            <div class="form-group">
                                <label>Número</label>
                                <input class="form-control" type="text" placeholder="Numero" name="numero" value="{{$colaborador->numero}}" required>
                            </div>

                            <div class="form-group">
                                <label>Bairro</label>
                                <input class="form-control" type="text" placeholder="Bairro" name="bairro" value="{{$colaborador->bairro}}" required>
                            </div>

                            <div class="form-group">
                                <label>Cidade</label>
                                <input class="form-control" type="text" placeholder="Cidade" name="cidade" value="{{$colaborador->cidade}}" required>
                            </div>

                            <div class="form-group">
                                <label>Estado</label>
                                <input class="form-control" type="text" placeholder="Estado" name="estado" value="{{$colaborador->estado}}" required>
                            </div>
